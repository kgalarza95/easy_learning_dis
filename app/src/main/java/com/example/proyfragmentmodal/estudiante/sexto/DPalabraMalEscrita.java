...
public class DPalabraMalEscrita extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista= inflater.inflate(R.layout.fragment_d_palabra_mal_escrita, container, false);
        try {
            ...
            webView.loadUrl("http://" + GlobalAplicacion.IP + "/php_api_dislexia/juegos/6to/unidad4/palabra_mal_escrita.html");
