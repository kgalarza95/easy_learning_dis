...
public class CLetraRecuadro extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista= inflater.inflate(R.layout.fragment_c_letra_recuadro, container, false);
        try {
            ...
            webView.loadUrl("http://" + GlobalAplicacion.IP + "/php_api_dislexia/juegos/6to/unidad3/letra_recuadro.html");
