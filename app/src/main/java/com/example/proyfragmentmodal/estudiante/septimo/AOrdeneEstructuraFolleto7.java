...
public class AOrdeneEstructuraFolleto7 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista = inflater.inflate(R.layout.fragment_a_ordene_estructura_folleto7, container, false);
        try {
            ...
            webView.loadUrl("http://" + GlobalAplicacion.IP + "/php_api_dislexia/juegos/7mo/unidad1/ordenar_estructura_folleto.html");
