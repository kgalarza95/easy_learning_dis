...
public class Palabras_Homofonas extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista = inflater.inflate(R.layout.fragment_palabras__homofonas, container, false);
        try {
            ...
            webView.loadUrl("http://" + GlobalAplicacion.IP + "/php_api_dislexia/juegos/5to/unidad4/palabra_homofona.html");
