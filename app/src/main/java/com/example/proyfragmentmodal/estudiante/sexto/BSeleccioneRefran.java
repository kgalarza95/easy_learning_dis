...
public class BSeleccioneRefran extends Fragment {

    View vista;
    ProgressDialog progressDialog;
    public BSeleccioneRefran() {
    }

    public static BSeleccioneRefran newInstance(String param1, String param2) {
        BSeleccioneRefran fragment = new BSeleccioneRefran();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista= inflater.inflate(R.layout.fragment_b_seleccione_refran, container, false);
        ...
        try {
            ...
            webView.loadUrl("http://" + GlobalAplicacion.IP + "/php_api_dislexia/juegos/6to/unidad2/refran_correcto.html");
